 ...
 */
                ...
                pub struct EnvironmentConfigLogSettings {
                    ...
                    #[serde(rename = "ConsoleLevel", skip_serializing_if = "Option::is_none", default, deserialize_with = "crate::de::parse_bool_opt")]
                    ...
                    #[serde(rename = "FileLevel", skip_serializing_if = "Option::is_none", default, deserialize_with = "crate::de::parse_bool_opt")]
                    pub file_level: Option<bool>,
                    #[serde(rename = "FileLocation", skip_serializing_if = "Option::is_none", default, deserialize_with = "crate::de::parse_bool_opt")]
